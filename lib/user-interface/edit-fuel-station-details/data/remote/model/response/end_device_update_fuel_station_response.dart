...
import 'package:pumped_end_device/user-interface/edit-fuel-station-details/data/remote/model/response/update_response.dart';

class EndDeviceUpdateFuelStationResponse extends UpdateResponse {
  EndDeviceUpdateFuelStationResponse(
      {
  ...
  factory EndDeviceUpdateFuelStationResponse.fromJson(final Map<String, dynamic> json) {
