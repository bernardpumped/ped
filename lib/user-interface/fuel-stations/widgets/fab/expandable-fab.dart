...
class _ExpandableFabState extends State<ExpandableFab>
  ...
  Widget _buildTapToCloseFab() {
    return SizedBox(width: 56.0, height: 56.0,
      child: Center(
        child: Material(
          shape: const CircleBorder(), clipBehavior: Clip.antiAlias, elevation: 4.0,
          child: InkWell(
            onTap: _toggle,
    ...
    for (var i = 0, angleInDegrees = 0.0; i < count; i++, angleInDegrees += step) {
      children.add(
        _ExpandingActionButton(
          ...
          maxDistance: widget.distance + 50,
    ...
    return IgnorePointer(
      ...
      child: AnimatedContainer(
        ...
        child: AnimatedOpacity(
          ...
          duration: const Duration(milliseconds: 250),
          child: FloatingActionButton(onPressed: _toggle, child: const Icon(Icons.sort))))
    );
  }
}
