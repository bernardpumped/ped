...
import 'package:pumped_end_device/user-interface/utils/animated-reorderable-list/diff_delegate.dart';
import 'package:pumped_end_device/user-interface/utils/animated-reorderable-list/myers_diff.dart';

typedef AnimatedItemBuilderCust<W extends Widget, E> = W Function(
...
abstract class ImplicitlyAnimatedListBase<W extends Widget, E extends Object>
  ...
  final AnimatedItemBuilderCust<W, E> itemBuilder;
...
B extends ImplicitlyAnimatedListBase<W, E>, E extends Object>
  ...
  @nonVirtual
  @protected
  AnimatedItemBuilderCust<W, E> get itemBuilder => widget.itemBuilder;
  @nonVirtual
  @protected
