...
class FavoriteFuelStationBookmark extends StatefulWidget {
  ...
  FavoriteFuelStationBookmark(this._fuelStation);
...
class _FavoriteFuelStationBookmarkState extends State<FavoriteFuelStationBookmark> {
  ...
  static const removeFavouriteIcon = const Icon(IconData(IconCodes.remove_from_favourites_icon_code, fontFamily: 'MaterialIcons'), color: _buttonIconColor);
  static const addToFavouriteIcon = const Icon(IconData(IconCodes.add_to_favourites_icon_code, fontFamily: 'MaterialIcons'), color: _buttonIconColor);

  @override
  Widget build(BuildContext context) {
    final FavoriteFuelStation station = new FavoriteFuelStation(
