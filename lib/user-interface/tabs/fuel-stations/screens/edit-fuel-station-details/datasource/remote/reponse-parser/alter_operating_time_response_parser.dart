...
class AlterOperatingTimeResponseParser extends ResponseParser<AlterOperatingTimeResponse> {
  @override
  AlterOperatingTimeResponse parseResponse(final String response) {
    return AlterOperatingTimeResponse.fromJson(convert.jsonDecode(response));
  }
}
