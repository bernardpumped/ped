...
class EndDeviceUpdateFuelStationResponseParser extends ResponseParser<EndDeviceUpdateFuelStationResponse> {
  @override
  EndDeviceUpdateFuelStationResponse parseResponse(final String response) {
    return EndDeviceUpdateFuelStationResponse.fromJson(convert.jsonDecode(response));
  }
}
