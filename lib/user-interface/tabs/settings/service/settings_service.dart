  ...
  Future<DropDownValues<FuelCategory>> fuelCategoryDropdownValues() async {
    ...
    if (marketRegionZoneConfig != null) {
      ...
      dropDownValues.selectedIndex =
          _getSelectedFuelCategoryIndex(dropDownValues.values, defaultFuelCategory, userDefaultFuelCategory, 1);
    } else {
    ...
    if (selectedFuelCat != null) {
      ...
      if (marketRegionFuelCategory != null && userDefaultFuelCategory != null) {
        final int selectedCategoryIndex =
            _getSelectedFuelCategoryIndex(fuelCategories, marketRegionFuelCategory, userDefaultFuelCategory, 2);
  ...
  Future<DropDownValues<SortOrder>> sortOrderDropdownValues() async {
    ...
    if (userConfiguration != null) {
      ...
      if (marketRegionZoneConfig != null) {
        ...
        dropDownValues.selectedIndex = _getSortOrderSelectedIndex(dropDownValues.values, null);
      }
    }
    return dropDownValues;
  }
