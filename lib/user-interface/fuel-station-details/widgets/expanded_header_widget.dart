...
class ExpandedHeaderWidget extends StatelessWidget {
  ...
  ExpandedHeaderWidget({Key? key, required this.fuelStation}) : super(key: key);
      ...
      if (publishers.isNotEmpty) {
        return Row(children: [
          Text('Fuel Price Source ${publishers[0]}',
              style: TextStyle(fontSize: 16, color: colorScheme.fuelStationDetailsTextColor, fontWeight: FontWeight.w500)),
  ...
  Widget _getDistanceWidget(final FuelStation fuelStation) {
    return Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
      ...
      Icon(const IconData(IconCodes.distanceIconCode, fontFamily: 'MaterialIcons'),
          color: colorScheme.fuelStationDetailsTextColor, size: 20), // drive_eta icon
