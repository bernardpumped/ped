...
class FuelPriceSourceCitationWidget extends StatelessWidget {
  ...
  const FuelPriceSourceCitationWidget(this.fuelQuote, this.fuelStation, this.fuelTypeName, {Key? key}) : super(key: key);
  ...
  Widget _getNotificationWidget() {
    ...
    if (notificationType == emailNotificationType) {
      ...
      return EmailNotificationWidget(
          emailBody: _getEmailBody(), emailSubject: _getEmailSubject(), source: fuelQuote.fuelQuoteSourceName!);
