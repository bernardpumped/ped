...
extension UpdateTypeExt on UpdateType {
  ...
  static const _updateTypeReadableNames = {
    UpdateType.operatingTime: 'Operating Time',
    UpdateType.price: 'Price',
    UpdateType.addressDetails: 'Address Details',
    UpdateType.phoneNumber: 'Phone Number',
    UpdateType.suggestEdit: 'Suggest Edit',
    UpdateType.fuelStationFeatures: 'Fuel Station Features'
  };

  String? get updateTypeName => _updateTypeNames[this];

  String? get updateTypeReadableName => _updateTypeReadableNames[this];
}
